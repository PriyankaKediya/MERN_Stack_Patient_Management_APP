  ...
  return (
    <Router>
      ...
      <div>          
          ...
          <Route render ={()=> < AddVitalSigns />} path="/addVitalSigns" />
          <Route render ={()=> < Checklist />} path="/checklist" />
          <Route render ={()=> < EmergencyAlert />} path="/emergencyAlert" />
          <Route render ={()=> < MotivationalVideos />} path="/motivationalVideos" />
          <Route render ={()=> < Game />} path="/game" />

          <Route render ={()=> < CreateMotivationalTip />} path="/createTip" />
         < Route render ={()=> < ShowMotivationalTip />} path="/showTip" />
          <Route render ={()=> < PatientInfo />} path="/patientInfo" />
          <Route render ={()=> < AddVitalSignsByNurse />} path="/vitals" />
          <Route render ={()=> < ShowEmergencyAlert />} path="/alert" />
